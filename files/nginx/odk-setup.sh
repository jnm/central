...
# Hack for HTTPS-only operation: the official NGINX Docker image comes with a conflicting default.conf
echo 'removing any existing nginx configuration files!'
